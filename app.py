...
with f1:
    st.markdown("**Eligibility scope conflict**")
    st.caption("CRM and contract disagree on the employer's eligible workforce. This can affect enrollment, billing, communications, and downstream device rules.")
with f2:
    st.markdown("**Device benefit mismatch**")
    st.caption("The employer-facing configuration does not fully match the contracted connected-device experience for enrolled members.")
with f3:
    st.markdown("**Launch ownership ambiguity**")
    st.caption("Employee communication ownership is inconsistent across implementation sources and needs a human decision.")

st.markdown("#### What the agent did")
st.write("Reconciled employer requirements across simulated CRM, contract, project, collaboration, meeting, and implementation-standard sources; surfaced conflicts; generated human-owned decisions and actions; connected employer decisions to downstream member/device dependencies; and assessed launch readiness without modifying source systems.")
